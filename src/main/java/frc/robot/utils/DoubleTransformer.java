...
/**
 * The {@code JoystickWrapper} class is a utility class for manipulating
...
public class DoubleTransformer implements DoubleSupplier {
    ...
    /**
     * Constructs a new {@code JoystickWrapper} instance with the specified
     * {@code DoubleSupplier}.
     * 
     ...
     * {@code DoubleSupplier}.
     * 
     * @return this {@code JoystickWrapper}
     */
    ...
    /**
     * Returns a new {@code JoystickWrapper} that negates the joystick input values.
     *
     * @return A new {@code JoystickWrapper} with negated values.
     */
    ...
    /**
     * Returns a new {@code JoystickWrapper} that squares the joystick input values.
     *
     * @return A new {@code JoystickWrapper} with squared values.
     */
     ...
     *
     * @return A new {@code JoystickWrapper} with signed squared values.
     */
    ...
    /**
     * Returns a new {@code JoystickWrapper} that applies a deadzone to the joystick
     * input values.
     *
     * @param deadzone The deadzone threshold for input values.
     * @return A new {@code JoystickWrapper} with deadzone applied.
     */
    ...
    /**
     * Returns a new {@code JoystickWrapper} that maps the joystick input values
     ...
     * @return A new {@code JoystickWrapper} with mapped values.
     */
    ...
    /**
     * Returns a new {@code JoystickWrapper} that applies a custom mapping function
     * to the joystick input values.
     *
     * @param f The mapping function to apply.
     * @return A new {@code JoystickWrapper} with the applied mapping function.
     */
